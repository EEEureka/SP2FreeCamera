    ...
    internal static class Localization
    {
        ...
        private static readonly Dictionary<string, string> English =
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                { "ConfigFovSmoothing", "Smoothing time for reaching the target FOV, including while any target is focused. This is independent of focus rotation smoothing. Set to 0 for immediate zoom changes." },
        ...
        private static readonly Dictionary<string, string> SimplifiedChinese =
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                { "ConfigFovSmoothing", "滚轮缩放到目标 FOV 所需的平滑时间，锁定任何目标时仍然生效，并与目标朝向平滑相互独立。设为 0 时缩放立即变化。" },
